...
/* definitions */
#define WIMPCK_CLASSNAME		"Wimcpk"
#define WIMPCK_TITLE			"Wimpck"	/* window name */
...
#define C_ICONS			(IDI_LASTICON-IDI_FIRSTICON)
  ...
  */
#define FILE_NORMAL		(2<<0)		// 2
#define FILE_DIRECTORY	(2<<1)		// 4
#define FILE_GOOD		(2<<2)		// 8
#define FILE_BAD		(2<<3)		// 16
#define FILE_ISMP3		(2<<4)		// 32
#define FILE_SCANNED    (2<<5)		// 64
